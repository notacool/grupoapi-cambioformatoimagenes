...
@click.option('--input', '-i', 'input_dir',
              help='Directorio de entrada con archivos TIFF')
...
@click.option('--list-formats', is_flag=True,
              help='Listar formatos disponibles y salir')
@click.option('--info', is_flag=True,
              help='Mostrar información del conversor y salir')
@click.option('--verbose', '-v', is_flag=True,
              help='Modo verbose con más información')
def main(input_dir, output_dir, formats, config_path, max_workers, 
         list_formats, info, verbose):
    """
    ...
    try:
        ...
        if verbose:
            _show_configuration(converter, input_dir, output_dir, format_list, max_workers)
